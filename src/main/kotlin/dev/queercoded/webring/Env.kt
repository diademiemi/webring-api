...
class Env {
    companion object {
        ...
        var webring_https_port: String =
            System.getenv("WEBRING_HTTPS_PORT")?.toString() ?: "8443"  // Only checked if webring_https is true

        var webring_https: String = System.getenv("WEBRING_HTTPS")?.toString() ?: "false"

        var webring_scraper_user_agent: String = System.getenv("WEBRING_SCRAPER_USER_AGENT")?.toString()
